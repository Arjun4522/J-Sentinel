...
public class scanner_test {
    ...
    private static String apiEndpoint = "http://localhost:8080/api/scan"; // Updated default endpoint
    ...
    private static void uploadGraph(JSONObject graph) throws IOException {
        System.out.println("Uploading code graph to: " + apiEndpoint); // Use the dynamic apiEndpoint
