...
public class analyse_test {
    ...
    private static JSONObject readCodeGraph() throws IOException {
        if (useApi) {
            String scanId = "fd01a841-ff0e-4f1e-9c9c-8e01fe973ed8"; // Example scanId; pass dynamically in practice
            String apiEndpoint = "http://localhost:8080/api/graph?scanId=" + scanId;
            HttpURLConnection conn = (HttpURLConnection) new URL(apiEndpoint).openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
            // Removed: conn.setRequestProperty("Authorization", "Bearer your-pre-generated-jwt-token");
